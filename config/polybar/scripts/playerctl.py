...
class Player:
    ...
    def __str__(self) -> str:
        ...
        #---Track
        if 'artist' in mt_d.keys() and mt_d['artist'] != '' and 'title' in mt_d.keys() and mt_d['artist'].lower() not in mt_d['title'].lower() and mt_d['artist'].replace(' ', '_').lower() not in mt_d['title'].lower():
